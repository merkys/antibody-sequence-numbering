...
ID_FILES := ${H_KABAT_CHOTIA_ID} ${L_KABAT_CHOTIA_ID} ${H_CHOTIA_ID} ${H_CHOTIA_ID} ${H_KABAT_ID} ${L_KABAT_ID}
...
regenerateClusters: ${CLUSTERED_FILES} ${FASTA_FILES}
...
${H_KABAT_ID} ${H_CHOTIA_ID} ${H_KABAT_CHOTIA_ID}: ${HEAVY_CHAINS_ALIGNMENT_COMPARE}
	./${IDENTIFY_SCHEME} ${HEAVY_CHAINS_ALIGNMENT_COMPARE} > "file.tmp"
	./${SORT_BY_SCHEME} ${ID_BY_SCHEME} 'H' "file.tmp"
	rm "file.tmp"

${L_KABAT_ID} ${L_CHOTIA_ID} ${L_KABAT_CHOTIA_ID}: ${LIGHT_CHAINS_ALIGNMENT_COMPARE}
