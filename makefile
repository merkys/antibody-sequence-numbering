...
LIGHT_CHAINS_ALIGMENT = ${HEAVY_LIGHT_ALIGMENTS}/light_aligment.${FASTA}
HEAVY_CHAINS_ALIGMENT = ${HEAVY_LIGHT_ALIGMENTS}/heavy_aligment.${FASTA}

# Link
PDB_LINK = http://www.rcsb.org/pdb/files

all: ${DATA_FILES} ${HEAVY_CHAINS_FASTA} ${LIGHT_CHAINS_FASTA} 
